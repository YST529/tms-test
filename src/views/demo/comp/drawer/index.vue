<template>
  <PageWrapper title="抽屉组件使用示例">
    ...
    <a-button class="my-4" type="primary" @click="openDrawerLoading"> 打开Drawer </a-button>

    <Alert message="内外同时控制显示隐藏" show-icon />
    <a-button class="my-4" type="primary" @click="openDrawer2(true)"> 打开Drawer </a-button>
    <Alert message="自适应高度/显示footer" show-icon />
    <a-button class="my-4" type="primary" @click="openDrawer3(true)"> 打开Drawer </a-button>

    <Alert message="内外数据交互" show-icon />
    <a-button class="my-4" type="primary" @click="send"> 打开Drawer并传递数据 </a-button>
    <Alert message="详情页模式" show-icon />
    <a-button class="my-4" type="primary" @click="openDrawer5(true)"> 打开详情Drawer </a-button>
